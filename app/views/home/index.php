            ...
            <div class="relative h-full flex items-center justify-center px-4">
                <div class="text-center max-w-3xl">
                    ...
                    <p class="text-xl text-white mb-8">
                        Tại DiTravel, chúng tôi cam kết mang đến cho bạn những trải nghiệm du lịch độc đáo, những dịch vụ chất lượng và những thông tin hữu ích để bạn có thể lên kế hoạch cho chuyến đi hoàn hảo.
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <button class="bg-teal-500 hover:bg-teal-600 text-white font-semibold py-3 px-8 rounded-lg transition duration-300">
                            Explore Destinations
                        </button>
                        <button class="bg-white hover:bg-gray-100 text-teal-500 font-semibold py-3 px-8 rounded-lg transition duration-300">
                            View Packages
                        </button>
                    </div>
                </div>
            ...
            <div class="max-w-6xl mx-auto bg-white rounded-lg shadow-lg -mt-16 relative z-10 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="flex items-end">
                        <button class="w-full bg-teal-500 hover:bg-teal-600 text-white font-semibold py-3 px-4 rounded-lg transition duration-300">
                            Search
                        </button>
                    </div>
                </div>
        ...
        <section class="py-16 px-4 bg-white">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="text-center mt-12">
                    <button class="bg-white border-2 border-teal-500 hover:bg-teal-50 text-teal-500 font-semibold py-3 px-8 rounded-lg transition duration-300">
        ...
        <section class="py-16 px-4 bg-teal-50">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <!-- Offer 1 -->
                    <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col md:flex-row">
                        <div class="md:w-2/5 h-64 md:h-auto">
                            <img
                                src="https://via.placeholder.com/300x300"
                                alt="Summer Beach Getaway"
                                class="w-full h-full object-cover" />
                        </div>
        ...
        <section class="py-16 px-4 bg-white">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <!-- Testimonial 1 -->
                    <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                        <div class="flex items-center mb-4">
                        ...
                        <p class="text-gray-600 mb-6 italic">
                            "The trip to Bali was absolutely amazing! The accommodations were perfect, and our guide was knowledgeable and friendly. I can't wait to book my next adventure!"
                        </p>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                        ...
                        <p class="text-gray-600 mb-6 italic">
                            "Our family trip to Japan exceeded all expectations. The itinerary was perfectly balanced with cultural experiences and fun activities for the kids. Highly recommended!"
                        </p>
                        <div class="flex items-center">
                            <div class="w-12 h-12 rounded-full overflow-hidden mr-4">
                                <img
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                        ...
                        <p class="text-gray-600 mb-6 italic">
                            "The European tour was the trip of a lifetime! Every detail was taken care of, and we got to experience the best of each city we visited. I'm already planning my next trip!"
                        </p>
                        <div class="flex items-center">
                            <div class="w-12 h-12 rounded-full overflow-hidden mr-4">
                                <img
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="max-w-xl mx-auto">
                    <form class="flex flex-col sm:flex-row gap-4">
                        ...
                        <button class="bg-white text-teal-500 hover:bg-gray-100 font-semibold py-3 px-6 rounded-lg transition duration-300">
                            Subscribe
                        </button>
                    </form>
        ...
        <section class="py-16 px-4 bg-gray-900 text-white">
            <div class="max-w-6xl mx-auto text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <button class="bg-transparent hover:bg-white hover:text-gray-900 text-white font-semibold py-3 px-8 rounded-lg border-2 border-white transition duration-300">
                        Contact Us
                    </button>
                </div>
            </div>
