...
<div class="content-wrapper">
    <div class="mx-auto py-6 px-4">
        ...
        <!-- Form thêm danh mục -->
        <form action="<?= UrlHelper::route('admin/tours/createCategory') ?>" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="p-6">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="mt-1 flex items-center">
                            <div class="w-32 h-32 border-2 border-gray-300 border-dashed rounded-md flex items-center justify-center mr-4">
                                <img id="preview-image" src="/placeholder.svg?height=128&width=128" alt="Preview" class="w-full h-full object-cover rounded-md hidden">
