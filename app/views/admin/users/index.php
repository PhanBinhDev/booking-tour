...
<div class="container px-6 py-8 mx-auto">
            ...
            <tr>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                ...
                <?php if ($user['id'] != $_SESSION['user_id']): ?>
                  <form action="/booking-tour/public/admin/users/delete/<?php echo $user['id']; ?>" method="POST" onsubmit="return confirm('Bạn chắc chắn muốn xóa?');">
  ...
  <div id="deleteUserModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 items-center justify-center z-50 hidden">
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md">
      ...
      <div class="p-4">
        <p class="text-gray-700">Bạn có chắc chắn muốn xóa người dùng <span id="delete"
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Ẩn modal khi bấm nút đóng hoặc Hủy
    function closeModal() {
      deleteModal.classList.add("hidden");
      deleteModal.classList.remove("flex");
    }
