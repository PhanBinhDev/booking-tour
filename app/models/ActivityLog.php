...
class ActivityLog extends BaseModel
{
     ...
     */
    public function log($entityType, $entityId, $description, $userId = null, $action = 'view')
    {
        ...
        $sql = "INSERT INTO {$this->table} (entity_type, entity_id, action, description, user_id, created_at)
            VALUES (:entity_type, :entity_id, :action, :description, :user_id, NOW())";
