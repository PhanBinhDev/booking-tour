...
class CloudinaryHelper {
    ...
    //     return (string) $this->cloudinaryInstance->image($publicId)->toUrl($options);
    // }

    // public function getImageByFolderAndName($folder, $name, $options = []) {
    //     $cloudinary = new \Cloudinary\Cloudinary();
    //     return (string) $cloudinary->image($folder . '/' . $name)->toUrl($options);
    // }
}